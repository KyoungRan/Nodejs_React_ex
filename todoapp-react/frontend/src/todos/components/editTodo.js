      ...
      <Table.Row>
        ...
        <Table.Cell>
          ...
          <DatePicker
            ...
            onChnage={this.changeNewDate}
          />
        </Table.Cell>
        {/* The options component takes the inputs and decide if it's an option for a Edit Todo or Add NewTodo */}
        <Options
...
// to the state events of their parent component through the props

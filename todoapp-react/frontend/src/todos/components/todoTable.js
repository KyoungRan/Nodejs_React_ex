...
const TodoTable = (props) => {
  return (
    <Table celled>
      ...
      <Table.Body>
        {/* This map the todos recieved as a prop */}
        { props.todos.map(t => {
          ...
          if(t.editing) {
            ...
            return (
              <TodoRow
                todo={t}
                key={t._id}
                comleteTodo={e => props.completeTodo(t)}
        ...
        {/* This EditTodo component us used as a Create new Todo Component */}
        {/* Thus by suing the same component for both use, we can reuse a lot of the codes */}
